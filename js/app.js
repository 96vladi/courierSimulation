...
function eventListeners(){
  ...
  email.addEventListener('blur', validarFormulario); //Blur es para que al salir se almacene lo que se escribio
...
function enviarEmail(e){
  ...
  // despues de 3 segundos ocultar el spinner
    //setTimeout se ejecuta solo una vez--- setInterval  se ejecuta cada 3 segundos o cuantos seg. le pongas
  setTimeout( ()=>{
